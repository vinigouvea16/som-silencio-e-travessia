...
export default function Processo() {
  return (
    <div className="h-lvh flex flex-col bg-[url('../public/how.webp')] relative bg-center bg-cover">
      {/* Overlay escuro */}
      ...
      <a
        href="#form"
        className="uppercase rounded-sm font-medium text-brown-dark font-family-arizona-flare bg-cream-light text-xl px-2 py-1 w-fit absolute bottom-[10%] left-[33%]"
      >
        inscrição
      </a>
    </div>
